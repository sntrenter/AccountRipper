...
def get_posts_till_date(username, date):
    ...
    for post in profile.get_posts():
        ...
        if post.date_utc.timestamp() < date:
            print("Photos before the date have been downloaded")
            break
...
if __name__ == "__main__":
    ...
    get_posts_till_date(username, date)
